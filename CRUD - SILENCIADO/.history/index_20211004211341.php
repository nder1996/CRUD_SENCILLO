                ...
                <thead>
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <th><a href="update.php?id=<?php echo $fila['id']; ?>" class="btn btn-primary">Editar</a></th>
                      <th><a href="delete.php?id=<?php echo $fila['id']; ?>" class="btn btn-primary">Eliminar</a></th>
                    </tr>
                    <?php endforeach ?>
                  </tbody>
              </table>
